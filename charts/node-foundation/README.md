...
[PARAMETERS.md](PARAMETERS.md) — deep dive on every parameter (what/default/why/failure mode) · [Node Performance and Tuning Configurations.md](Node%20Performance%20and%20Tuning%20Configurations.md) — the same material as beginner-friendly tables · [CLAUDE.md](CLAUDE.md) — why-each-decision guidance · [BIOS.md](BIOS.md) — the out-of-band BIOS + `mlxconfig` firmware half of this layer · [HYPERSHIFT.md](HYPERSHIFT.md) — delivering this layer via `NodePool` on Hosted Control Planes.
